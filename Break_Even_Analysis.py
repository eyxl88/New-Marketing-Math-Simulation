...
class Total():
    def __init__(self, unit_instance):
        ...
        self.fc = round(unit_instance.fc * self.expected_sales, 2)
        self.revenue = round(unit_instance.selling_price * self.expected_sales)
        ...
        self.market_size = round((random.uniform(1,1000) * self.revenue), 2)
...
print(f"Unit Variable Cost: ${unit.vc:.2f}\nTotal Fixed Cost: ${total.fc:,d}")
print(f"Unit Selling Price: ${unit.selling_price:.2f}")
...
be_units.correct = f"Correct! The Break Even number is {answer.be_units:,d} units."
be_units.wrong = f"The correct Break Even number was {answer.be_units_raw:,.1f} units rounded up to a whole number.\n" \
              f"The break even number is total fixed costs / unit selling price - variable costs per unit.\n" \
              f"This means (${total.fc:,d} / ${unit.selling_price:.2f}) + ${unit.vc:.2f} in this case."
...
be_dollars.wrong = f"The correct Break Even total revenue was ${answer.be_dollars:,.2f}.\n" \
              ...
              f"This means {answer.be_units:,d} * ${unit.selling_price:.2f} in this case."
...
completion = False
while completion == False:
    user_be_ms = get_user_input("Input the market share the company needs to capture to break even as a percentage: ", float)
...
unit2 = Unit()
total2 = Total(unit2)
answer2 = ProblemAnswers(unit2, total2)

print("Values to be used in the Break Even PRICING problem:")
print(f"Unit Variable Cost: ${unit2.vc:.2f}\nTotal Fixed Cost: ${total2.fc:,d}")
print(f"Units sold: {total2.expected_sales:,d}")
...
be_selling_price.wrong = f"The correct Break Even selling price per unit was ${answer2.be_selling_price:.2f}.\n" \
              ...
              f"This means (${total2.fc:,d} / {total2.expected_sales:,d}) + ${unit2.vc:,.2f} in this case."
